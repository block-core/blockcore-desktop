    ...
    constructor(private log: Logger) {
        ...
        if (!ChainService.singletonInstance) {
            ...
            this.availableChains = [
                ...
                { opreturndata: 80, pos: true, rootFolderName: 'cybits', test: false, name: 'Cybits', chain: 'Cybits', private: 160, public: 28, identity: 'Cybits', tooltip: 'Cybits', port: 17771, rpcPort: 17772, apiPort: 17773, network: 'CybitsMain', genesisDate: new Date(Date.UTC(2021, 10, 1)) },
