    ...
    constructor(private log: Logger) {
        ...
        if (!ChainService.singletonInstance) {
            ...
            this.availableChains = [
                ...
                { pos: true, rootFolderName: 'x1', test: false, name: 'X1', chain: 'X1', private: 128, public: 0, identity: 'X1', tooltip: 'X1', port: 23333, rpcPort: 43333, apiPort: 43334, network: 'X1Main', genesisDate: new Date(2018, 1, 1) },
                { pos: false, rootFolderName: 'xrc', test: false, name: 'xRhodium', chain: 'XRC', private: 100, public: 61, identity: 'x42', tooltip: 'X42', port: 37270, rpcPort: 19660, apiPort: 37221, network: 'xRhodiumMain', genesisDate: new Date(2018, 1, 1) },
                { pos: true, rootFolderName: 'homecoin', test: false, name: 'HomeCoin', chain: 'HOME', private: 160, public: 40, identity: 'home', tooltip: 'HomeCoin', port: 33331, rpcPort: 33332, apiPort: 33333, network: 'HomeCoinMain', genesisDate: new Date(2018, 1, 1) },
