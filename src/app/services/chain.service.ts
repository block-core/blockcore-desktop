    ...
    constructor(private log: Logger) {
        ...
        if (!ChainService.singletonInstance) {
            ...
            this.availableChains = [
                ...
                { pos: true, rootFolderName: 'xrc', test: false, name: 'xRhodium', chain: 'XRC', private: 100, public: 61, identity: 'x42', tooltip: 'X42', port: 37270, rpcPort: 19660, apiPort: 37221, network: 'xRhodiumMain', genesisDate: new Date(2018, 1, 1) },
                { pos: true, rootFolderName: 'homecoin', test: false, name: 'HomeCoin', chain: 'HOME', private: 160, public: 40, identity: 'home', tooltip: 'HomeCoin', port: 52342, rpcPort: 52343, apiPort: 42220, network: 'HomeCoinMain', genesisDate: new Date(2018, 1, 1) },
