    ...
    constructor(private log: Logger) {
        ...
        if (!ChainService.singletonInstance) {
            ...
            this.availableChains = [
                ...
                { opreturndata: 40, pos: true, rootFolderName: 'city', test: false, name: 'City Chain', unit: 'CITY', coin: 'City Coin', chain: 'CITY', private: 237, public: 28, identity: 'city', tooltip: 'City Hub', port: 4333, rpcPort: 4334, apiPort: 4335, wsPort: 4336, network: 'CityMain', genesisDate: new Date(2018, 9, 1) },
                { opreturndata: 40, pos: true, rootFolderName: 'city', test: true, name: 'City Chain (RegTest)', unit: 'TCITY', chain: 'CITY', private: 194, public: 66, identity: 'city', tooltip: 'City Hub', port: 14333, rpcPort: 14334, apiPort: 14335, wsPort: 14336, network: 'CityRegTest', genesisDate: new Date(2018, 9, 1) },
                { opreturndata: 40, pos: true, rootFolderName: 'city', test: true, name: 'City Chain (Test)', unit: 'TCITY', chain: 'CITY', private: 194, public: 66, identity: 'city', tooltip: 'City Hub', port: 24333, rpcPort: 24334, apiPort: 24335, wsPort: 24336, network: 'CityTest', genesisDate: new Date(2018, 9, 1) },
